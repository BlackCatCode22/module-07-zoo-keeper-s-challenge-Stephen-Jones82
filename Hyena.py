...
class Hyena(Animal):
    ...
    def init(self, name="a_name", animal_id="an_id", birth_date="2099-01-01", color="a_color", sex="a_sex",
        ...
        super().init("hyena", name, animal_id, birth_date, color, sex, weight, originating_zoo, date_arrival)
